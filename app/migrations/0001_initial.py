# Generated by Django 5.2.8 on 2025-11-05 19:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='pf', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='PessoaJuridica',
            fields=[
                ...
                ('estado', models.CharField(max_length=2)),
                ('pais', models.CharField(max_length=50)),
                ('cliente', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='pj', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
